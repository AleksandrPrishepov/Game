...
class Scores():
    ...
    def image_score(self):
        ...
        self.score_rect = self.score_img.get_rect()  # создаем объект со счетом в виде прямоугольника
        self.score_rect.right = self.screen_rect.right - 40  # от куда начинается его правая сторона
        self.score_rect.top = 20  # указываем от куда начинается верх нашего прямоугольника со счетом
